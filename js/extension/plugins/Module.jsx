...
import {
    tabouLoadIdentifyContent, printProgramme, createChangeFeature,
    displayFeatureInfos, dipslayPASAByOperation, getFicheInfoValues
} from '../epics/identify';
...
import {
    listTabouDocuments,
    downloadTabouDocuments,
    deleteTabouDocuments,
    addNewDocument,
    updateDocument
} from "../epics/documents";
...
export default {
    ...
    containers: {
        ...
        SidebarMenu: {
            name: "Tabou2",
            position: 10,
            icon: <img src={iconUrbamap} alt="Tabou2"/>,
            tooltip: "tabou2.btnTooltip",
            doNotHide: true,
            action: toggleControl.bind(null, CONTROL_NAME, null),
            priority: 1
